...
#if defined(NDEBUG)
# error "castellum cannot be compiled without assertions."
#endif

#define ZEROCOIN_MODULUS   ""
...
uint256 hashGenesisBlock("0x20c3bc12792c0dfd4ce1674cff19326f36d570fd5fc950085290dbb54cffcc65");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 1); // castellum: starting difficulty is 1 / 2^12
...
int64 nChangeChainIDTime = 1476476112;
...
int64 CTransaction::nMinTxFee = 1000000; // 0.01 castellum
/** Fees smaller than this (in ztoshi) are considered zero fee (for relaying) */
int64 CTransaction::nMinRelayTxFee = 1000000; // 0.01 castellum
...
const string strMessageMagic = "Castellum Signed Message:\n";
...
{
    // Castellum: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 60; // 1 minute between retargets
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
	...
	static const uint32_t	BlocksTargetSpacing	= 60; // 1 min
	unsigned int			TimeDaySeconds	= 60 * 60 * 24;
	int64					PastSecondsMin	= TimeDaySeconds / 1440; // 1
	int64					PastSecondsMax	= TimeDaySeconds;// 86400
	uint32_t				PastBlocksMin	= PastSecondsMin / BlocksTargetSpacing; // 1 block
	uint32_t				PastBlocksMax	= PastSecondsMax / BlocksTargetSpacing; // 1440
...
bool CBlock::CheckBlock(CValidationState &state, int nHeight, bool fCheckPOW, bool fCheckMerkleRoot, bool isVerifyDB) const
{
    ...
    // Castellum: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Castellum: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 2;
        block.nTime    = 1476476112;
        block.nBits    = startBits;
        block.nNonce   = 1810366;
        ...
        assert(block.hashMerkleRoot == uint256("0x365d2aa75d061370c9aefdabac3985716b1e3b4bb7c4af4ed54f25e5aaa42783"));
...
if (true && block.GetHash() != hashGenesisBlock)
        {
            ...
            loop
            {
				LYRA2M4(BEGIN(thash), 32, BEGIN(block.nVersion), 80, BEGIN(block.nVersion), 80, 2, 4, 256);
                if (thash <= hashTarget)
                    break;
...
unsigned char pchMessageStart[4] = { 0xa2, 0xf4, 0xff, 0xd1 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CastellumMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CastellumMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("CastellumMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Castellum-Miner");
    ...
    try { loop {
        ...
        loop
        {
            ...
            loop
            {
				LYRA2M4(BEGIN(thash), 32, BEGIN(pblock->nVersion), 80, BEGIN(pblock->nVersion), 80, 2, 4, 256);
