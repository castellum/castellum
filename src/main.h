...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 CASTL
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 CASTL mininput
...
public:
    ...
    uint256 GetPoWHash() const
    {
		...
		LYRA2M4(BEGIN(thash), 32, BEGIN(nVersion), 80, BEGIN(nVersion), 80, 2, 4, 256);
